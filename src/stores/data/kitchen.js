export const kitchenData = [
  {
    id: "1",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/1.jpg`,
    type: "Blender",
    brand: "Vitamix",
  ...
  },
  {
    id: "2",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/2.jpg`,
    type: "Cookware Set",
    brand: "Calphalon",
  ...
  },
  {
    id: "3",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/3.jpg`,
    type: "Coffee Maker",
    brand: "Keurig",
    model: "K-Elite",
    price: "149.50",
  ...
  },
  {
    id: "4",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/4.jpg`,
    type: "Knife Set",
    brand: "Wusthof",
  ...
  },
  {
    id: "5",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/5.jpg`,
    type: "Stand Mixer",
    brand: "KitchenAid",
  ...
  },
  {
    id: "6",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/6.png`,
    type: "Baking Set",
    brand: "Pyrex",
    model: "Bake & Store",
    price: "49.99",
  ...
  },
  {
    id: "7",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/7.jpg`,
    type: "Rice Cooker",
    brand: "Zojirushi",
    model: "Neuro Fuzzy",
    price: "119.00",
  ...
  },
  {
    id: "8",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/8.jpg`,
    type: "Utensil Set",
    brand: "OXO",
    model: "Good Grips",
    price: "29.99",
  ...
  },
  {
    id: "9",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/9.jpg`,
    type: "Food Processor",
    brand: "Cuisinart",
    model: "DLC-8SBCY",
    price: "129.99",
  ...
  },
  {
    id: "10",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/10.jpg`,
    type: "Mixer",
    brand: "OXO",
  ...
  },
  {
    id: "11",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/11.jpg`,
    type: "Dish Set",
    brand: "Corelle",
  ...
  },
  {
    id: "12",
    product: "Kitchen",
    image: `${process.env.PUBLIC_URL}/assets/Kitchen/12.jpg`,
    type: "Slow Cooker",
    brand: "Crock-Pot",
