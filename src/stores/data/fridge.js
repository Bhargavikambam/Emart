export const fridgeData = [
  {
    ...
    image: `${process.env.PUBLIC_URL}/assets/fridge/1.jpg`,
    brand: "LG",
  ...
  },
  {
    id: "2",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/2.jpg`,
    brand: "Samsung",
  ...
  },
  {
    id: "3",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/3.jpg`,
    brand: "Whirlpool",
    model: "ChillZone 300",
    price: "899.99",
    category: "Electronics",
  ...
  },
  {
    id: "4",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/4.jpg`,
    brand: "Frigidaire",
    model: "CoolMist XL",
    price: "599.50",
    category: "Electronics",
  ...
  },
  {
    id: "5",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/5.jpg`,
    brand: "KitchenAid",
  ...
  },
  {
    id: "6",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/6.jpg`,
    brand: "GE",
    model: "SmartCool+",
    price: "1199.99",
    category: "Electronics",
  ...
  },
  {
    id: "7",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/7.jpg`,
    brand: "Maytag",
  ...
  },
  {
    id: "8",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/8.jpg`,
    brand: "Bosch",
  ...
  },
  {
    id: "9",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/9.jpg`,
    brand: "Haier",
  ...
  },
  {
    id: "10",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/10.jpg`,
    brand: "Sub-Zero",
    model: "ProChill 8000",
    price: "2999.00",
    category: "Electronics",
  ...
  },
  {
    id: "11",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/11.jpg`,
    brand: "Kenmore",
    model: "Elite Series",
    price: "1199.00",
    category: "Electronics",
  ...
  },
  {
    id: "12",
    product: "Refrigerator",
    image: `${process.env.PUBLIC_URL}/assets/fridge/12.jpg`,
    brand: "Viking",
